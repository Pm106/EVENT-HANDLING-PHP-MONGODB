...
$collection = $db->Event;
$query = $collection->find(['category' => 'Wedding Events']);
...
<source src="vid/WhatsApp Video 2025-03-04 at 12.18.41_890ad663.mp4" type="video/mp4">
</video></div><div>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php
                                ...
                                if ($imageData instanceof MongoDB\BSON\Binary) {
                                    ...
                                    ?>
                                    <img src="default-image.jpg" style="width: 1500px;" class="card-img-top" alt="...">
                                    <?php
                                }
                                ?>
                                <div class="card-body">
